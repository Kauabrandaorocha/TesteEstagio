...
if __name__ == "__main__":
    ...
    # pasta onde está o consolidado original (entrada)
    pasta_entrada = os.path.join(pasta_atual, "consolidado_despesas")
    # pasta onde será salvo o consolidado validado (saída)
    pasta_saida = os.path.join(pasta_atual, "consolidado_validado")
